...
class ProductsScreen extends StatelessWidget {
  ...
  Widget builderWidget(ShopHomeModel model, CategoriesModel categoriesModel, context) => SingleChildScrollView(
  ...
  Widget buildGridProduct(ShopProducts model, context) => Container(
    color: Colors.white,
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
